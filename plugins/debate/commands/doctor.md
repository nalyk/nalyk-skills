---
description: "Check debate system health - probes agy/codex/vibe challenger CLIs with live auth round-trips and caches the working list."
allowed-tools: Bash
---
...
Then:
- **DISABLED** (0 challengers): tell the user debates will refuse to run until at least one challenger CLI (agy, codex, or vibe) is installed and authenticated, using the install hints the script printed.
