...
### Content Quality
- Word count vs page type minimums (see `${CLAUDE_PLUGIN_ROOT}/skills/seo/references/quality-gates.md`)
...
(`cd "${CLAUDE_PLUGIN_ROOT}" && python3 -m engine.cli audit <url> --max-pages 1`) —
