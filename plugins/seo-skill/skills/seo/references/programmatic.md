...
Thresholds come from `${CLAUDE_PLUGIN_ROOT}/skills/seo/references/quality-gates.md`
(single source of truth):

| Metric | Threshold | Action |
|--------|-----------|--------|
| Programmatic/location pages | 30+ | ⚠️ WARNING — enforce 60%+ unique content per page |
| Programmatic/location pages | 50+ | 🛑 HARD STOP — require explicit user justification |
...
### Safe vs Risky Page Types

See the safe-at-scale vs penalty-risk tables in
`${CLAUDE_PLUGIN_ROOT}/skills/seo/references/quality-gates.md`.
